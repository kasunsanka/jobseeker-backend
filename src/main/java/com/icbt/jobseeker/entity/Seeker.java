...
@Entity// Specify the name of the database table
public class Seeker {
    @Id
    ...
    public Seeker(Long id, String firstname, String nic, String address, String mobile, String email, String occupation, String exceptedcountry, String exceptedjob, double exceptedsalary, String remark, String date, String time, String status) {
        this.id = id;
